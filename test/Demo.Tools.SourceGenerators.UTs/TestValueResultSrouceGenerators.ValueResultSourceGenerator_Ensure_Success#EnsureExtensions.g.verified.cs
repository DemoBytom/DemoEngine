...
public static class EnsureExtensions
{
        ...
        where TError : global::Demo.Tools.Common.ValueResults.IError, allows ref struct
    {
        ...
        public global::Demo.Tools.Common.ValueResults.ValueResult<TValue, TError> Ensure(
            EnsurePredicate<TValue> predicate,
            EnsureOnErrorNoValueFunc<TError> onError)
            => result.IsError
            || predicate(result.Value)
                ? result
                : global::Demo.Tools.Common.ValueResults.ValueResult<TValue, TError>.Failure(
        ...
        public global::Demo.Tools.Common.ValueResults.ValueResult<TValue, TError> Ensure<TParam1>(
            scoped in TParam1 param1,
            EnsurePredicate<TValue> predicate,
            EnsureOnErrorNoValueFunc<TError, TParam1> onError)
            => result.IsError
            || predicate(result.Value)
                ? result
                : global::Demo.Tools.Common.ValueResults.ValueResult<TValue, TError>.Failure(
        ...
        public global::Demo.Tools.Common.ValueResults.ValueResult<TValue, TError> Ensure<TParam1, TParam2>(
            ...
            scoped in TParam2 param2,
            EnsurePredicate<TValue> predicate,
            EnsureOnErrorNoValueFunc<TError, TParam1, TParam2> onError)
            => result.IsError
            || predicate(result.Value)
                ? result
                : global::Demo.Tools.Common.ValueResults.ValueResult<TValue, TError>.Failure(
                    onError(param1, param2));
        ...
        public global::Demo.Tools.Common.ValueResults.ValueResult<TValue, TError> Ensure<TParam1, TParam2, TParam3>(
            ...
            scoped in TParam3 param3,
            EnsurePredicate<TValue> predicate,
            EnsureOnErrorNoValueFunc<TError, TParam1, TParam2, TParam3> onError)
            => result.IsError
            || predicate(result.Value)
                ? result
                : global::Demo.Tools.Common.ValueResults.ValueResult<TValue, TError>.Failure(
                    onError(param1, param2, param3));
        ...
        public global::Demo.Tools.Common.ValueResults.ValueResult<TValue, TError> Ensure<TParam1, TParam2, TParam3, TParam4>(
            ...
            scoped in TParam4 param4,
            EnsurePredicate<TValue> predicate,
            EnsureOnErrorNoValueFunc<TError, TParam1, TParam2, TParam3, TParam4> onError)
            => result.IsError
            || predicate(result.Value)
                ? result
                : global::Demo.Tools.Common.ValueResults.ValueResult<TValue, TError>.Failure(
                    onError(param1, param2, param3, param4));
        ...
        public global::Demo.Tools.Common.ValueResults.ValueResult<TValue, TError> Ensure<TParam1, TParam2, TParam3, TParam4, TParam5>(
            ...
            scoped in TParam5 param5,
            EnsurePredicate<TValue> predicate,
            EnsureOnErrorNoValueFunc<TError, TParam1, TParam2, TParam3, TParam4, TParam5> onError)
            => result.IsError
            || predicate(result.Value)
                ? result
                : global::Demo.Tools.Common.ValueResults.ValueResult<TValue, TError>.Failure(
                    onError(param1, param2, param3, param4, param5));
        ...
        public global::Demo.Tools.Common.ValueResults.ValueResult<TValue, TError> Ensure<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6>(
            ...
            scoped in TParam6 param6,
            EnsurePredicate<TValue> predicate,
            EnsureOnErrorNoValueFunc<TError, TParam1, TParam2, TParam3, TParam4, TParam5, TParam6> onError)
            => result.IsError
            || predicate(result.Value)
                ? result
                : global::Demo.Tools.Common.ValueResults.ValueResult<TValue, TError>.Failure(
                    onError(param1, param2, param3, param4, param5, param6));
        ...
        public global::Demo.Tools.Common.ValueResults.ValueResult<TValue, TError> Ensure<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7>(
            ...
            scoped in TParam7 param7,
            EnsurePredicate<TValue> predicate,
            EnsureOnErrorNoValueFunc<TError, TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7> onError)
            => result.IsError
            || predicate(result.Value)
                ? result
                : global::Demo.Tools.Common.ValueResults.ValueResult<TValue, TError>.Failure(
                    onError(param1, param2, param3, param4, param5, param6, param7));
        ...
        public global::Demo.Tools.Common.ValueResults.ValueResult<TValue, TError> Ensure<TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7, TParam8>(
            ...
            scoped in TParam8 param8,
            EnsurePredicate<TValue> predicate,
            EnsureOnErrorNoValueFunc<TError, TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7, TParam8> onError)
            => result.IsError
            || predicate(result.Value)
                ? result
                : global::Demo.Tools.Common.ValueResults.ValueResult<TValue, TError>.Failure(
                    onError(param1, param2, param3, param4, param5, param6, param7, param8));
    ...
    /// Ensure on error func delegate with 0 extra parameters
    /// </summary>
    public delegate TError EnsureOnErrorNoValueFunc<TError>()
        where TError : global::Demo.Tools.Common.ValueResults.IError, allows ref struct;
    
    /// <summary>
    /// Ensure on error func delegate with 1 extra parameters
    /// </summary>
    public delegate TError EnsureOnErrorNoValueFunc<TError, TParam1>(scoped in TParam1 param1)
        where TError : global::Demo.Tools.Common.ValueResults.IError, allows ref struct
        where TParam1 : allows ref struct;
    ...
    /// Ensure on error func delegate with 2 extra parameters
    /// </summary>
    public delegate TError EnsureOnErrorNoValueFunc<TError, TParam1, TParam2>(scoped in TParam1 param1,
        scoped in TParam2 param2)
        where TError : global::Demo.Tools.Common.ValueResults.IError, allows ref struct
        where TParam1 : allows ref struct
        where TParam2 : allows ref struct;
    ...
    /// Ensure on error func delegate with 3 extra parameters
    /// </summary>
    public delegate TError EnsureOnErrorNoValueFunc<TError, TParam1, TParam2, TParam3>(scoped in TParam1 param1,
        scoped in TParam2 param2,
        scoped in TParam3 param3)
        where TError : global::Demo.Tools.Common.ValueResults.IError, allows ref struct
        where TParam1 : allows ref struct
    ...
    /// Ensure on error func delegate with 4 extra parameters
    /// </summary>
    public delegate TError EnsureOnErrorNoValueFunc<TError, TParam1, TParam2, TParam3, TParam4>(scoped in TParam1 param1,
        scoped in TParam2 param2,
        scoped in TParam3 param3,
        scoped in TParam4 param4)
        where TError : global::Demo.Tools.Common.ValueResults.IError, allows ref struct
    ...
    /// Ensure on error func delegate with 5 extra parameters
    /// </summary>
    public delegate TError EnsureOnErrorNoValueFunc<TError, TParam1, TParam2, TParam3, TParam4, TParam5>(scoped in TParam1 param1,
        scoped in TParam2 param2,
        scoped in TParam3 param3,
        scoped in TParam4 param4,
        scoped in TParam5 param5)
    ...
    /// Ensure on error func delegate with 6 extra parameters
    /// </summary>
    public delegate TError EnsureOnErrorNoValueFunc<TError, TParam1, TParam2, TParam3, TParam4, TParam5, TParam6>(scoped in TParam1 param1,
        scoped in TParam2 param2,
        scoped in TParam3 param3,
        scoped in TParam4 param4,
        scoped in TParam5 param5,
    ...
    /// Ensure on error func delegate with 7 extra parameters
    /// </summary>
    public delegate TError EnsureOnErrorNoValueFunc<TError, TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7>(scoped in TParam1 param1,
        scoped in TParam2 param2,
        scoped in TParam3 param3,
        scoped in TParam4 param4,
        scoped in TParam5 param5,
    ...
    /// Ensure on error func delegate with 8 extra parameters
    /// </summary>
    public delegate TError EnsureOnErrorNoValueFunc<TError, TParam1, TParam2, TParam3, TParam4, TParam5, TParam6, TParam7, TParam8>(scoped in TParam1 param1,
        scoped in TParam2 param2,
        scoped in TParam3 param3,
        scoped in TParam4 param4,
        scoped in TParam5 param5,
